//#include "CGWorld.h"
//
//#include "CashGen/Public/CGWorldFace.h"
//#include "CashGen/Public/CGWorldGeneratorWorker.h"
//
...
//	MeshData.Reserve(WorldConfig.MeshDataPoolSize);
//
//	for (int i = 0; i < WorldConfig.MeshDataPoolSize; i++)
//	{
//		MeshData.Add(FCGWorldMeshData());
//		MyFreeMeshData.Add(&MeshData[MeshData.Num() - 1]);
//	}
//
...
//
//	Indices.Append(indices, ARRAY_COUNT(indices));
//
//	UWorld* _world = GetWorld();
//
//	for (int i = 0; i < 20; i++)
//	{
//		Faces.Add(_world->SpawnActor<ACGWorldFace>(ACGWorldFace::StaticClass(), FVector(0.0f), FRotator(0.0f)));
//		Faces[Faces.Num() - 1]->SetupFace(MyVertices[Indices[i * 3]],
//			MyVertices[Indices[(i * 3) + 1]],
//			MyVertices[Indices[(i * 3) + 2]],
//			FVector(0.0f),
...
//			{
//				updateJob.pFace->UpdateMesh(updateJob.pMeshData->Vertices, updateJob.pMeshData->myIndices, WorldConfig);
//
